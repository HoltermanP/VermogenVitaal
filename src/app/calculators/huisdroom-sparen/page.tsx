...
import { calculateHomeDreamSavings, type HomeDreamSavingsResult } from "@/lib/calculators/home-dream-savings"

export default function HomeDreamSavingsPage() {
  const [formData, setFormData] = useState({
    goalAmount: 50000,
    currentSavings: 10000,
    monthlyContribution: 500,
    interestRate: 2,
    goalType: 'purchase' as 'purchase' | 'renovation' | 'repayment'
  })

  const [results, setResults] = useState<HomeDreamSavingsResult | null>(null)

  const handleCalculate = () => {
    const result = calculateHomeDreamSavings({
      ...formData,
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Bereken spaarplan voor koopsom, verbouwing of aflossing
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <Card className="bg-card/80 backdrop-blur-sm border-border shadow-xl">
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label htmlFor="goalType">Doel</Label>
                  <Select value={formData.goalType} onValueChange={(value: 'purchase' | 'renovation' | 'repayment') => setFormData({ ...formData, goalType: value })}>
                    <SelectTrigger className="mt-1">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="purchase">Koopsom</SelectItem>
                      <SelectItem value="renovation">Verbouwing</SelectItem>
                      <SelectItem value="repayment">Aflossing</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                    ...
                    <div className="p-4 bg-accent/10 border border-primary/20 rounded-xl">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{results.yearsToGoal.toFixed(1)} jaar</span>
                        </div>
                      </div>
                    </div>
