        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-700 mb-6">
              <strong>Laatste update:</strong> 1 januari 2024
            </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Geen advies</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Nauwkeurigheid van informatie</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Aansprakelijkheid</h2>
              <p className="text-gray-700 mb-4">
