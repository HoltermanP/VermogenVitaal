...
// BELANGRIJK: Deze hook moet alleen worden aangeroepen als Clerk beschikbaar is
// en we binnen een ClerkProvider zijn
function useClerkUser() {
  // Alleen useUser aanroepen als Clerk beschikbaar is
  // Dit wordt alleen aangeroepen binnen ClerkUserContent, die alleen wordt gerenderd
  // als Clerk beschikbaar is (zie ClerkUserSection)
  const clerkData = useUser()
  return clerkData
}

// Separate component voor Clerk user - wordt dynamisch geïmporteerd om build errors te voorkomen
// Deze component wordt alleen gerenderd als Clerk beschikbaar is (zie ClerkUserSection)
function ClerkUserContent() {
  ...
  // Deze hooks worden alleen aangeroepen als Clerk beschikbaar is en we binnen ClerkProvider zijn
