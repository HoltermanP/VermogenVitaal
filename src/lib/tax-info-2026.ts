...
import type { TaxTopic, TaxSection } from "./tax-info-2025"

export const taxTopics2026: TaxTopic[] = [
  {
    id: "inkomstenbelasting",
    title: "Inkomstenbelasting 2026",
    shortDescription: "Alles over de tarieven, schijven en heffingskortingen voor inkomstenbelasting in 2026",
    icon: TrendingUp,
    ...
    sections: [
      {
        title: "Belastingtarieven 2026",
        important: true,
        content: "De inkomstenbelasting kent in 2026 twee belastingschijven:",
        subsections: [
          {
            title: "Schijf 1: Tot €77.200",
            content: "Het tarief voor de eerste schijf bedraagt 36,97%. Dit tarief geldt voor het belastbare inkomen tot en met €77.200."
          },
          {
            title: "Schijf 2: Vanaf €77.200",
            content: "Voor het belastbare inkomen boven €77.200 geldt een tarief van 49,50%. Dit is het hoogste tarief in het Nederlandse belastingstelsel."
          }
        ]
      },
      {
        title: "Heffingskortingen",
        content: "Heffingskortingen verminderen het bedrag aan belasting dat je moet betalen. In 2026 zijn de belangrijkste heffingskortingen:",
        subsections: [
          {
            title: "Algemene heffingskorting",
            content: "De algemene heffingskorting bedraagt in 2026 €3.140 voor personen tot 65 jaar en €1.570 voor personen vanaf 65 jaar. Deze korting wordt automatisch toegepast."
          },
          {
            title: "Arbeidskorting",
            content: "De arbeidskorting is afhankelijk van je arbeidsinkomen. Het maximum bedraagt €5.200 voor 2026. Hoe hoger je inkomen, hoe lager de arbeidskorting wordt."
          },
          {
            title: "Inkomensafhankelijke combinatiekorting",
            content: "Als je een partner hebt en jullie allebei werken, kunnen jullie recht hebben op de inkomensafhankelijke combinatiekorting. Het maximum bedraagt €2.950 in 2026."
          }
        ]
      },
      {
    ...
    importantNotes: [
      ...
      "Voor 2026 zijn de schijfgrenzen en heffingskortingen aangepast ten opzichte van 2025."
    ]
  },
  {
    id: "vennootschapsbelasting",
    title: "Vennootschapsbelasting 2026",
    ...
    sections: [
      {
        title: "Belastingtarieven 2026",
        important: true,
        content: "De vennootschapsbelasting (VPB) kent in 2026 twee tarieven:",
        subsections: [
          {
      ...
      },
      {
        ...
        subsections: [
          {
            title: "Minimum DGA-salaris 2026",
            content: "Het minimum DGA-salaris bedraagt €52.000 bij een winst tot €200.000 en €76.000 bij een winst vanaf €200.000. Dit salaris is belast in box 1."
          },
          {
  ...
  {
    id: "aftrekposten",
    title: "Aftrekposten & Kortingen 2026",
    ...
    sections: [
      {
        ...
        subsections: [
          {
            title: "Bedrag 2026",
            content: "De zelfstandigenaftrek bedraagt in 2026 €5.150. Dit bedrag wordt afgetrokken van je winst uit onderneming."
          },
          {
            title: "Urencriterium",
          ...
          },
          {
            ...
            content: "Nieuwe ondernemers kunnen naast de zelfstandigenaftrek ook gebruik maken van de startersaftrek van €2.180. Dit geldt voor de eerste 5 jaar van je onderneming."
          }
        ]
      },
      {
        ...
        subsections: [
          {
            ...
            content: "De arbeidskorting wordt berekend op basis van je arbeidsinkomen. Het maximum bedraagt €5.200 in 2026."
          },
          {
            title: "Afbouw",
            content: "De arbeidskorting wordt afgebouwd bij een inkomen boven €77.200. Bij een inkomen van €122.000 of hoger is er geen arbeidskorting meer."
          },
          {
            title: "Voor wie",
    ...
    sections: [
      {
        ...
        subsections: [
          ...
          {
            title: "Maximum",
            content: "Het maximumbedrag voor lijfrentepremies is beperkt. Voor 2026 bedraagt het maximum ongeveer €17.500, afhankelijk van je inkomen en pensioenopbouw."
          },
          {
            title: "Voorwaarden",
      ...
      },
      {
        ...
        subsections: [
          ...
          {
            title: "Maximum",
            content: "Het maximumbedrag voor de FOR bedraagt ongeveer €10.200 per jaar. Dit bedrag wordt jaarlijks geïndexeerd."
          },
          {
            title: "Opname",
      ...
      },
      {
        ...
        subsections: [
          ...
          {
            title: "AOW-leeftijd",
            content: "De AOW-leeftijd wordt jaarlijks verhoogd en is afhankelijk van je geboortejaar. Voor mensen geboren in 1966 is de AOW-leeftijd 67 jaar en 4 maanden."
          },
          {
            title: "AOW-bedrag",
  ...
  {
    id: "box3",
    title: "Box 3: Vermogensbelasting 2026",
    shortDescription: "Belasting over sparen en beleggen, box 3 regeling en heffingsvrije voet",
    icon: PiggyBank,
    category: "Vermogen",
    color: "indigo",
    relatedTopics: ["inkomstenbelasting"],
    sections: [
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            content: "Er is een heffingsvrije voet van €58.000 per persoon (€116.000 voor fiscale partners) in 2026. Over dit bedrag hoef je geen belasting te betalen."
          },
          {
            title: "Tarief",
      ...
      {
        title: "Box 3 regeling 2026",
        important: true,
        content: "In 2026 geldt de box 3 regeling:",
        subsections: [
          {
        ...
        subsections: [
          {
            ...
            content: "Zorg dat je optimaal gebruik maakt van de heffingsvrije voet van €58.000 per persoon."
          },
          {
    ...
    importantNotes: [
      "De heffingsvrije voet is €58.000 per persoon in 2026.",
      "Box 3 belasting wordt berekend over je vermogen per 1 januari.",
      "De box 3 regeling is een vereenvoudiging van de oude regeling."
    ]
  },
  {
    id: "eigenwoning",
    title: "Eigen Woning & Hypotheek 2026",
    ...
    sections: [
      {
        ...
        subsections: [
          ...
          {
            title: "Afbouw",
            content: "De hypotheekrenteaftrek wordt geleidelijk afgebouwd. Het maximumpercentage daalt jaarlijks met 0,5% tot 36,93% in 2026."
          },
          {
            title: "Maximum",
      ...
      },
      {
        ...
        subsections: [
          {
            title: "Berekeningswijze",
            content: "Het eigenwoningforfait wordt berekend als een percentage van de WOZ-waarde van je woning. Voor 2026 bedraagt dit 0,35%."
          },
          {
            title: "WOZ-waarde",
          ...
          {
            title: "Maximum",
            content: "Het eigenwoningforfait is beperkt tot een maximum. Voor 2026 is dit ongeveer €1.250 per jaar."
          }
        ]
      },
      {
    ...
    sections: [
      {
        ...
        subsections: [
          {
            title: "Tarief",
            content: "Het tarief voor dividendbelasting bedraagt 26,5% in 2026. Dit is een definitieve heffing."
          },
          {
            title: "Wie betaalt?",
...
export function getTaxTopicById2026(id: string): TaxTopic | undefined {
  return taxTopics2026.find(topic => topic.id === id)
}

export function getRelatedTopics2026(topicId: string): TaxTopic[] {
  const topic = getTaxTopicById2026(topicId)
  if (!topic || !topic.relatedTopics) return []
  
  return topic.relatedTopics
    .map(id => getTaxTopicById2026(id))
